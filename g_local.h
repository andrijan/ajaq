...
extern cvar_t *knife_mod;
extern cvar_t *heroes;
...
void fire_grenade2 (edict_t * self, vec3_t start, vec3_t aimdir, int damage,
		    int speed, float timer, float damage_radius,
		    qboolean held);
void fire_proximity_mine (edict_t * self, vec3_t start, vec3_t aimdir, int damage,
		    int speed, float timer, float damage_radius,
		    qboolean held);
...
#define PROXMINE_NAME "Proximity Mine"
...
#define WPF_PROXMINE  0x00000200
