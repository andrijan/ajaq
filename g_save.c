...
void InitGame (void)
{
	...
	knife_mod = gi.cvar ("knife_mod", "0", CVAR_SERVERINFO | CVAR_LATCH);
	heroes = gi.cvar ("heroes", "0", CVAR_SERVERINFO | CVAR_LATCH);
	...
	wp_flags = gi.cvar ("wp_flags", "1023", 0);	// 511 = WPF_MK23 | WPF_MP5 | WPF_M4 | WPF_M3 | WPF_HC | WPF_SNIPER | WPF_DUAL | WPF_KNIFE | WPF_GRENADE | WPF_PROXMINE
	itm_flags = gi.cvar ("itm_flags", "127", 0);	// 63 = ITF_SIL | ITF_SLIP | ITF_BAND | ITF_KEV | ITF_LASER | ITF_HELM | ITF_JETPACK
	...
	proxmine = gi.cvar ("proxmine", "0", CVAR_SERVERINFO);
	//SLIC2
    ...
    heroweapon = gi.cvar ("heroweapon", "", CVAR_SERVERINFO); //ESJ
